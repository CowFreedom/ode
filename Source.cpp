...
void testlotkavolterra() {
	...
	std::array<double, 2> tspan = { 0,30 };
	std::array<double, 2> u0 = { 200,100 };
	clock_t begin = std::clock();
	r::ode1(functions, tspan, u0, 0.001);

	clock_t end = clock();
//	printTrajectory(r::ode4(functions, tspan, u0, 0.2));
...
//	printTrajectory(r::ode4(functions, tspan, u0, 0.1));
