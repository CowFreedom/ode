...
dopri<rk_Container1D, rk_Container2D>::dopri() {
	...
	do_setB_Plus<rk_Container1D::value_type>({(35/static_cast<double>(384)),0,(500/static_cast<double>(1113)),(125/static_cast<double>(192)),(-2187/static_cast<double>(6784)),(static_cast<double>(11)/84),0});
